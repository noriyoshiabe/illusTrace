...
char *NACStringDuplicateNString(const char *str, int length, char *buffer)
{
...
int NACStringSplitCount(char *str, const char *delim)
{
    int ret = 0;
    char *pc = str;
    bool delimiter = true;
...
char **NACStringSplit(char *str, const char *delim, int *length, char **buffer)
{
    if (length) {
        *length = 0;
    }
